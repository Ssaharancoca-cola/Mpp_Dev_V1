...
var EndYear = 21; //End Year offset. i.e. Current Year + 5
...
function NewCssCal(pCtrl, pFormat, pScroller, pShowTime, pTimeMode, pHideSeconds) {
	...
	if ((pShowTime != null) && (pShowTime)) {
		...
		if (pHideSeconds != null) {
			if (pHideSeconds) { Cal.ShowSeconds = false; }
...
function RenderCssCal(bNewCal) {
	...
	if (UseImageFiles) {
		vCalTime += "<table width='100%' border='0' cellpadding='0' cellspacin='0'><tr>";
		vCalTime += "<td align='left'><img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='UserControls/images/cross.png' width='16px' height='14px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white' alt='Close' Title='Close'></td>";
		vCalTime += "<td align='right'><img onmousedown='javascript:clearwin(\"" + Cal.Ctrl + "\"); stopSpin();' src='UserControls/images/paintbrush.png' width='16px' height='14px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white' alt='Clear' Title='Clear'></td>";
		vCalTime += "</tr></table>";
	}
	else {
		vCalTime += "<table width='100%' border='0' cellpadding='0' cellspacin='0'><tr>";
		vCalTime += "<td align='left'><span id='close_cal' title='close'onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\");' onmouseover='changeBorder(this, 0)'onmouseout='changeBorder(this, 1)' style='border:1px solid white; font-family: Arial;font-size: 10pt;'>x</span></td>";
		vCalTime += "<td align='left'><span id='clear_cal' title='clear'onmousedown='javascript:clearwin(\"" + Cal.Ctrl + "\");' onmouseover='changeBorder(this, 0)'onmouseout='changeBorder(this, 1)' style='border:1px solid white; font-family: Arial;font-size: 10pt;'>x</span></td>";
		vCalTime += "</tr></table>";
	}
	vCalTime += "</td>";
...
function GetMonthIndex(shortMonthName) {
	for (i = 0; i < 12; i++) {
		if (MonthName[i].substring(0, 3).toUpperCase() == shortMonthName.toUpperCase()) { return i; }
	}
}
