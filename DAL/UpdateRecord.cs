...
namespace DAL
{
    ...
    //                    string attrData = Convert.ToString(attrList.Find(x => x.ATTR_NAME == data.Key.ToString()));
    //                    if (!string.IsNullOrEmpty(attrData))
    //                    {
    //                        selectColumn.Append(data.Key + " , ");
    //                        string attrDataType = attrList.Find(x => x.ATTR_NAME == data.Key.ToString()).ATTR_DATA_TYPE;
    //                        switch (attrDataType)
    //                        {
    //                            case "VC":
    //                            case "SUPPLIED_CODE":
    ...
    //                updateQuery.Append("MDM_APP." + inputTableName + " SET ");
    ...
    //            using (MPP_Context objmdmContext = new MPP_Context("MDMAppContext"))
    //            {
    ...
    //                {
    //                    ldOid = objGetSequenceValue.GetNextSequenceValue("MDM_CORE.SEQ_LD_OID", out outMsg);
    //                    if (outMsg != Constant.statusSuccess) return outMsg;
    //                }
    ...
    //                insertQuery.Append("MDM_APP." + inputTableName + "(");
    ...
    //            using (MPP_Context objmdmContext = new MPP_Context("MDMAppContext"))
    //            {
    //                noOfRowInserted = objmdmContext.Database.ExecuteSqlCommand(finalQuery.ToString());
    //            }
    //        }
    //        catch (Exception ex)
    //        {
    ...
    //        try
    //        {
    //            using (MPP_ContextProcedures objMdmContext = new MPP_ContextProcedures())
    //            {
    //                objMdmContext.MPP_LOAD_CHKAsync(sessionId.ToString(), entityTypeId.ToString(), userID.ToUpper(), suppressWarning);
    //            }
    //        }
    //        catch (Exception ex)
    //        {
    ...
    //            strQuery.Append("(" + "MDM_APP." + inputTablename + ")");
    //            strQuery.Append(strWhereClause);
    ...
    //        try
    //        {
    //            using (MPP_Context objMdmContext = new MPP_Context(Constant.mdmAppDataBaseConnName))
    //            {
    ...
    //    {
    //        string outMsg = Constant.statusSuccess;
    //        string deleteQuery = "DELETE FROM MDM_APP." + tableName + " WHERE " + Constant.rowStatus + " = 1 AND " + Constant.sessionID + "  =  " + "'" + sessionId + "'";
    //        int noOfRowDeleted;
    //        try
    //        {
    //            using (MPP_Context objmdmContext = new MPP_Context("MDMAppContext"))
