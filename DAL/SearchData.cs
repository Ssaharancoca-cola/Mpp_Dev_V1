...
namespace DAL
{
    ...
    //            {
    //                dataType = objmdmContext.Database.ExecuteSqlRaw<string>(sqlQuery).FirstOrDefault();
    //            }
    //        }
    //        catch (Exception ex)
    //        {
    ...
    //    }
    //    public DataSet search(List<SearchParameter> searchParameter, int PageNo, int PageSize, string SortBy, string SortOrder, string UserName,
    //        int entityTypeId, out string OIDColumnName, out string outMsg)
    //    {
    //        outMsg = Constant.statusSuccess;
    ...
    //    }
    //    public string GetSearchQuery1(string fieldList, int PageNo, int PageSize, string SortBy, string SortOrder, string tableName,
    //        List<SearchParameter> searchParameter, List<EntityTypeAttr> attrNameList, string OIDColumnName, out string searchQuery)
    //    {
    ...
    //    public string GetSearchQuery(string fieldList, int PageNo, int PageSize, string SortBy, string SortOrder, string tableName,
    //        List<SearchParameter> searchParameter, List<EntityTypeAttr> attrNameList, string OIDColumnName, out string searchQuery)
    //    {
    //        string outMsg = Constant.statusSuccess;
    //        string strAsSelectClause = string.Empty;
    ...
    //        if (tableName.ToUpper().StartsWith("MDM_APP.FL_"))
    //        {
    //            if (tableName.ToUpper() == "MDM_APP.FL_DSP")
    //            {
    //                strSortClause += ", PROPERTY_SEQ ASC ";
    //            }
    //            else
    //            {
    //                strSortClause += ", " + tableName.ToUpper().Replace("MDM_APP.FL_", "") + "_OID ASC ";
    //            }
    //        }
